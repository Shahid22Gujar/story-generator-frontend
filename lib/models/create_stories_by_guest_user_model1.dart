...
@NowaGenerated()
class CreateStoriesByGuestUserModel1 {
  @NowaGenerated({'loader': 'auto-from-json'})
  factory CreateStoriesByGuestUserModel1.fromJson(
      {required Map<String, dynamic> json}) {
    return CreateStoriesByGuestUserModel1(
      id: json['id'],
      genre: json['genre'],
  ...
  const CreateStoriesByGuestUserModel1(
      {this.id,
      this.genre,
      this.timePeriod,
      this.character,
  ...
  CreateStoriesByGuestUserModel1 copyWith(
      {String? id,
      dynamic genre,
      String? timePeriod,
      String? character,
