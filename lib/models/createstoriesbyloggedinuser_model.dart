...
@NowaGenerated()
class CreateStoriesByLoggedInUserModel {
  @NowaGenerated({'loader': 'auto-constructor'})
  const CreateStoriesByLoggedInUserModel(
      {this.timePeriod,
      this.character,
      this.writingStyle,
      this.storyText,
  ...
  factory CreateStoriesByLoggedInUserModel.fromJson(
      {required Map<String, dynamic> json}) {
    return CreateStoriesByLoggedInUserModel(
  ...
  CreateStoriesByLoggedInUserModel copyWith(
      {String? timePeriod,
      String? character,
      String? writingStyle,
      String? storyText,
